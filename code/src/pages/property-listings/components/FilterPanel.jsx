...
const FilterPanel = ({ 
  ...
  const priceRanges = [
    ...
    { min: '1000000', max: '', label: 'Trên 1M$' }
  ];

  const amenitiesList = [
    'Chỗ đậu xe', 'Hồ bơi', 'Phòng Gym', 'Cho phép nuôi thú cưng', 'Ban công', 'Vườn',
    'Lò sưởi', 'Điều hòa', 'Hệ thống sưởi', 'Máy giặt', 'Máy rửa chén',
    'Thang máy', 'Lễ tân', 'An ninh', 'Kho', 'Sân thượng'
  ];
      ...
      `}>
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border">
            <h2 className="text-lg font-semibold text-text-primary">Bộ lọc</h2>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Thành phố, khu vực, mã ZIP"
                    className="block w-full pl-10 pr-3 py-2 border border-border rounded-md
                             focus:border-border-focus focus:ring-1 focus:ring-primary-500
                             transition-all duration-200 ease-out text-sm"
                  />
              ...
              <div>
                ...
                >
                  <span className="text-sm font-medium text-text-primary">Loại BĐS</span>
                  <Icon 
                    name="ChevronDown" 
                    size={16} 
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full text-left"
                >
                  <span className="text-sm font-medium text-text-primary">Khoảng giá</span>
                  <Icon 
                    name="ChevronDown" 
                    size={16} 
                    className={`text-text-secondary transition-transform duration-200 ${
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div className="pt-3 border-t border-border">
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-xs text-text-secondary mb-1">Giá tối thiểu</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="block text-xs text-text-secondary mb-1">Giá tối đa</label>
                          <input
                            type="number"
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full text-left"
                >
                  <span className="text-sm font-medium text-text-primary">Phòng ngủ & Phòng tắm</span>
                  <Icon 
                    name="ChevronDown" 
                    size={16} 
                    className={`text-text-secondary transition-transform duration-200 ${
                ...
                {expandedSections?.bedsBaths && (
                  <div className="mt-3 space-y-4">
                    <div>
                      <label className="block text-xs text-text-secondary mb-2">Số phòng ngủ</label>
                    ...
                    <div>
                      <label className="block text-xs text-text-secondary mb-2">Số phòng tắm</label>
                      <div className="flex space-x-2">
                        {['', '1', '2', '3', '4+']?.map((bath) => (
                          <button
                            key={bath}
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full text-left"
                >
                  <span className="text-sm font-medium text-text-primary">Diện tích (Sqft)</span>
                  <Icon 
                    name="ChevronDown" 
                    size={16} 
                    className={`text-text-secondary transition-transform duration-200 ${
                ...
                {expandedSections?.size && (
                  <div className="mt-3">
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="block text-xs text-text-secondary mb-1">Tối thiểu</label>
                        <input
                          type="number"
                      ...
                      <div>
                        <label className="block text-xs text-text-secondary mb-1">Tối đa</label>
                        <input
                          type="number"
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full text-left"
                >
                  <span className="text-sm font-medium text-text-primary">Tiện ích</span>
                  <Icon 
                    name="ChevronDown" 
                    size={16} 
                    className={`text-text-secondary transition-transform duration-200 ${
