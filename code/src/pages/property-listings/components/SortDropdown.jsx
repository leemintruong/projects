...
const SortDropdown = ({ value, onChange }) => {
  ...
  const sortOptions = [
    { value: 'relevance', label: 'Phù hợp nhất', icon: 'Star' },
    { value: 'price-low', label: 'Giá: Thấp → Cao', icon: 'TrendingUp' },
    { value: 'price-high', label: 'Giá: Cao → Thấp', icon: 'TrendingDown' },
    { value: 'newest', label: 'Mới nhất', icon: 'Clock' },
    { value: 'oldest', label: 'Cũ nhất', icon: 'History' },
    { value: 'size', label: 'Diện tích lớn nhất', icon: 'Maximize' }
  ];
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span>Sắp xếp: {selectedOption?.label}</span>
        <Icon 
          name="ChevronDown" 
          size={16} 
