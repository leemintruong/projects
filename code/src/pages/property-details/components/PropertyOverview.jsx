...
const PropertyOverview = ({ 
  ...
  const getPropertyAge = (yearBuilt) => {
    ...
    return age === 0 ? 'Mới xây dựng' : `${age} năm tuổi`;
  };
    ...
    <div className="card p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6">
        <div className="text-center p-3 bg-background rounded-md">
          ...
          <p className="text-sm text-text-secondary">Phòng ngủ</p>
        </div>
        ...
        <div className="text-center p-3 bg-background rounded-md">
          ...
          <p className="text-sm text-text-secondary">Phòng tắm</p>
        </div>
        ...
        <div className="text-center p-3 bg-background rounded-md">
          ...
          <p className="text-sm text-text-secondary">Diện tích (ft²)</p>
        </div>
        ...
        {property?.yearBuilt && (
          <div className="text-center p-3 bg-background rounded-md">
            ...
            <p className="text-sm text-text-secondary">Năm xây dựng</p>
          </div>
        )}
        ...
        {property?.parkingSpaces > 0 && (
          <div className="text-center p-3 bg-background rounded-md">
            ...
            <p className="text-sm text-text-secondary">Chỗ đậu xe</p>
          </div>
        )}
        ...
        <div className="text-center p-3 bg-background rounded-md">
          ...
          <p className="text-sm text-text-secondary">Ngày đăng bán</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4 text-sm">
        ...
        {property?.yearBuilt && (
          <div className="flex items-center space-x-2">
            ...
            <span className="text-text-secondary">Tuổi nhà:</span>
        ...
        {property?.lotSize && (
          <div className="flex items-center space-x-2">
            ...
            <span className="text-text-secondary">Diện tích đất:</span>
            <span className="font-medium text-text-primary">{formatNumber(property?.lotSize)} ft²</span>
          </div>
        )}
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-xs text-text-secondary">
                {property?.agent?.rating} ({property?.agent?.reviewsCount} đánh giá)
              </span>
            </div>
          </div>
          <button
