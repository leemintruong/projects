      ...
      <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 mb-8">
          <div className="relative group">
            <div
              className="w-24 h-24 rounded-full overflow-hidden bg-secondary-100 cursor-pointer"
          ...
          <div className="mt-4 sm:mt-0 flex-1">
            <h3 className="text-lg font-medium text-text-primary">{formData?.name || 'Tên của bạn'}</h3>
            <p className="text-text-secondary text-sm mb-3">
              Nhấn vào ảnh để tải ảnh đại diện mới
            </p>
          ...
          {user?.role === 'agent' && (
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Giới thiệu kinh nghiệm và chuyên môn của bạn..."
                maxLength={500}
              />
      ...
      {showCropModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-modal flex items-center justify-center p-4">
          <div className="bg-surface rounded-lg shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-text-primary mb-4">Cắt ảnh đại diện</h3>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-text-secondary mt-2">
                Chức năng cắt ảnh sẽ được triển khai với thư viện crop chuyên dụng
              </p>
            </div>
