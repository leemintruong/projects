  ...
  const actions = [
    {
      ...
      description: 'Tạo một tin đăng bất động sản mới',
      icon: 'Plus',
      color: 'primary',
    ...
    },
    {
      ...
      description: 'Đặt lịch hẹn xem bất động sản',
      icon: 'Calendar',
      color: 'accent',
      onClick: () => console.log('Lên lịch xem nhà')
    },
    {
      id: 'import-leads',
      title: 'Nhập Khách Hàng',
      description: 'Tải khách hàng tiềm năng từ CSV hoặc CRM',
      icon: 'Upload',
      color: 'success',
      onClick: () => console.log('Nhập khách hàng')
    },
    {
      id: 'generate-report',
      title: 'Tạo Báo Cáo',
      description: 'Xuất báo cáo phân tích hiệu suất',
      icon: 'FileText',
      color: 'warning',
      onClick: () => console.log('Tạo báo cáo')
    }
  ];
