...
const LeadManagement = () => {
  ...
  const columns = [
    {
      ...
      color: 'secondary',
      leads: [
        { id: 1, name: 'John Smith', property: '123 Đường Sồi', score: 85 },
        { id: 2, name: 'Sarah Johnson', property: '456 Đại lộ Thông', score: 92 }
      ]
    },
    {
      id: 'contacted',
      ...
      color: 'primary',
      leads: [
        { id: 3, name: 'Mike Davis', property: '789 Đường Phong', score: 78 },
        { id: 4, name: 'Lisa Chen', property: '321 Ngõ Du', score: 88 }
      ]
    },
    {
      id: 'showing',
      title: 'Đã đặt lịch xem',
      color: 'warning',
      leads: [
        { id: 5, name: 'Robert Brown', property: '555 Ngõ Tuyết Tùng', score: 95 }
      ]
    },
    {
      id: 'offer',
      title: 'Chờ chấp nhận đề nghị',
      color: 'success',
      leads: [
        { id: 6, name: 'Emily Wilson', property: '777 Đường Bạch Dương', score: 98 }
      ]
    }
  ];
  ...
  const handleDrop = (e, targetColumn) => {
    ...
    if (draggedLead && draggedLead?.sourceColumn !== targetColumn) {
      console.log(`Chuyển khách hàng ${draggedLead?.lead?.name} từ ${draggedLead?.sourceColumn} sang ${targetColumn}`);
      // TODO: Thêm logic cập nhật trạng thái khách hàng
    }
    setDraggedLead(null);
  };
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-text-primary font-heading">
            Quy trình khách hàng tiềm năng
          </h3>
            ...
            >
                ...
                {column?.leads?.map((lead) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      <button className="text-text-secondary hover:text-text-primary transition-colors duration-200" title="Gọi điện">
                        <Icon name="Phone" size={12} />
                      </button>
                      <button className="text-text-secondary hover:text-text-primary transition-colors duration-200" title="Gửi email">
                        <Icon name="Mail" size={12} />
                      </button>
                      <button className="text-text-secondary hover:text-text-primary transition-colors duration-200" title="Nhắn tin">
              ...
              {column?.leads?.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-text-secondary text-sm">Chưa có khách hàng</p>
                </div>
              )}
            </div>
          ))}
