    ...
    <>
      <div className="relative" ref={menuRef}>
        ...
        <button
          ...
          aria-haspopup="true"
          aria-label={`Tab hiện tại: ${activeTabData?.label}. Nhấn để mở menu.`}
        >
              ...
              {tabs?.map((tab) => (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-4 py-3 text-left transition-colors duration-200 focus:outline-none focus:bg-secondary-100 ${
                    activeTab === tab?.id
                      ? 'bg-primary-100 text-primary border-r-2 border-primary'
